...
public class Heap<K,V> implements PriorityQueue<K,V> {
	...
	/**
	 * Consulta si la cola estï¿½ vacï¿½a.
	 * @return Verdadero si la cola estï¿½ vacï¿½a, falso en caso contrario.
	 */
	 ...
	 * @throws EmptyPriorityQueueException si la cola estï¿½ vacï¿½a.
	 */
	 ...
	 * @throws InvalidKeyException si la clave es invï¿½lida.
	 */
